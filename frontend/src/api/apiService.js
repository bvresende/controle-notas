...
/* regras para cada tipo de avaliação */
...
/* Função para obtenção de todas as notas a partir do back end */
async function getAllGrades() {
  ...
  /* Obtem próximo id a partir do valor máximo existente */
  let maxId = -1;
