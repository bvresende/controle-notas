...
export default function ModalGrade({ onSave, onClose, selectedGrade }) {
  ...
  /* efeito para obter a validação da API a partid do type */
  useEffect(() => {
  ...
  /* verifica se a nota informada pelo usuário é válida, monitorando gradeValue e gradeValidation */
  useEffect(() => {
  ...
  /* monitora a tecla Esc, através de keydown */
  useEffect(() => {
  ...
  /* fecha modal caso 'esc' seja digitado */
  ...
  /* lida com o envio de dados do formulário */ 
  /* devemos prevenir o envio e tratar manualmente */
  ...
  /* lidando com a mudança da nota no input */
